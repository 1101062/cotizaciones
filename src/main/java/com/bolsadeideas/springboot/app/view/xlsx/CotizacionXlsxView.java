...
public class CotizacionXlsxView  extends AbstractXlsxView {
    @Override
    protected void buildExcelDocument(Map<String, Object> model,
        ...
        Cotizacion factura = (Cotizacion) model.get("factura");

        Sheet sheet = workbook.createSheet("Cotizacion Spring");
        ...
        cell.setCellValue(factura.getGestor().getNombres() + " " + factura.getGestor().getApellidos());

        row = sheet.createRow(2);
        cell = row.createCell(0);
        cell.setCellValue(factura.getGestor().getEmail());
        ...
        sheet.createRow(6).createCell(0).setCellValue(mensajes.getMessage("text.cliente.factura.descripcion") + ": " + factura.getObservacion());
        ...
        int rowNum = 10;
        for(ItemCotizacion item: factura.getItems() ) {
